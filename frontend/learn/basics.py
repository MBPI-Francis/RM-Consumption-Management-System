...
class FileSearchEngine(ttk.Frame):
    ...
    def create_results_view(self):
        ...
        self.resultview.bind("<Button-3>", self.on_right_click)
    ...
    def on_right_click(self, event):
        ...
        if iid:
            self.resultview.selection_set(iid)  # Select row under the cursor
    ...
    def open_file(self):
        ...
        if selected_item:
            file_path = self.resultview.item(selected_item, "values")[4]  # Get file path
            pathlib.os.startfile(file_path)  # Open file
