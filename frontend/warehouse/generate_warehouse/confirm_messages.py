...
from frontend.warehouse.generate_warehouse.core_function import GenerateWarehouse
...
class ConfirmationMessage:
    ...
    def show_confirmation_message(self):
        ...
        message_label = ttk.Label(
            confirmation_window,
            text=(
                "To ensure the program functions correctly, the following warehouses will be generated:\n"
                "    • Warehouse #1\n"
                "    • Warehouse #2\n"
                "    • Warehouse #4\n"
        ...
        submit_button = ttk.Button(
            ...
            bootstyle=SUCCESS,
            state=DISABLED,
            command=lambda: [GenerateWarehouse(self.root).generate_warehouse(), confirmation_window.destroy()]
        )
