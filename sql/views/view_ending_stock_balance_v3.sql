         ...
         SELECT ib.rawmaterialid,
			...
			+
                CASE
					...
					THEN (- COALESCE(rej.total_held, 0::numeric)) - COALESCE(rej.total_released, 0::numeric) + COALESCE(
                    CASE
                    ...
                    CASE
                        ...
                        ELSE NULL::numeric
                    END, 0::numeric)
                    WHEN ib.statusname::text = 'good'::text THEN (- COALESCE(good.total_held, 0::numeric)) - COALESCE(ogr.total_ogr_quantity, 0::numeric) + COALESCE(good.total_released, 0::numeric) + COALESCE(
                    CASE
