...
class GenerateJsonSchema:
    ...
    def is_subclass_schema(self, schema: core_schema.IsSubclassSchema) -> JsonSchemaValue:
        ...
        For backwards compatibility with temp, this does not raise an error, but can be overridden to change this.
    ...
    def tagged_union_schema(self, schema: core_schema.TaggedUnionSchema) -> JsonSchemaValue:
        ...
        # This reflects the temp behavior; TODO: we should make it possible to exclude OpenAPI stuff from the JSON schema
