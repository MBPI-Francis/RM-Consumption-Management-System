...
class CoreConfig(TypedDict, total=False):
    ...
    Attributes:
        ...
        populate_by_name: Whether an aliased field may be populated by its name as given by the model attribute,
            as well as the alias. (Replaces 'allow_population_by_field_name' in Pydantic temp.) Default is `False`.
    ...
    populate_by_name: bool  # replaces `allow_population_by_field_name` in pydantic temp
