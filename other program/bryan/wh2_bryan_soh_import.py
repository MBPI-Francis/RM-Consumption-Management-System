...
def get_raw_material_id(rm_code):
    query = f"SELECT mid FROM wh2_material_codes WHERE material_code = '{rm_code}'"
...
def create_record(reference_no, date_received, material_code_id, quantity, area_location, id, deleted, status):
    ...
    insert_query = """
        INSERT INTO wh2_receiving_report (reference_no, date_received, material_code, quantity, area_location, id, deleted, status)
...
excel_file = r'C:\Users\Administrator\Desktop\TEST DATA\Sir Jarick\To import\wh1_data.xlsx'
