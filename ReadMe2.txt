There are two environments in this repository:
1. env - Used for running the program in my personal computer
2. venv - Used for running the program in my office computer
